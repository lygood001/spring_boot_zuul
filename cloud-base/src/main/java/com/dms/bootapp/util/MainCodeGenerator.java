...
import com.dms.bootapp.domain.sys.TableDO;
    ...
    public static void generatorCode(Map<String, String> table, List<Map<String, String>> columns, ZipOutputStream zip) {
        ...
        for (String template : templates) {
            ...
            try {
                ...
                System.out.println("渲染模板失败，表名：" + tableDO.getTableName()+e);
            }
        }
    }
...
////        }
    ...
    public static Configuration getConfig() {
        try {
            ...
            throw new BootException("获取配置文件失败，", e);
        }
    }
    ...
    public static String getFileName(String template, String classname, String className, String packageName) {
        ...
        if (template.contains("Mapper.xml.vm")) {
            return "main" + File.separator + "resources"+File.separator + "mybatis"  +File.separator+className+ File.separator + className + "Mapper.xml";
        }
